...
DIETAS = ['Frutas', 'Invertebrados', 'Vertebrados', 'Onívoro',  'Sem Informação', 'Carnívoro', 'Herbívoro', 'Néctar', 'Sementes', 'Peixes', 'Plantas', 'Necrófago', 'Ovívoro', 'Cera de Abelha']

ALCANCE_RESTRITO  = ['SIM', 'NÃO', 'NÃO INFORMADO']
REPROD_ILHAS      = ['SIM', 'NÃO']
SEXO_INCUBACAO    = ['FEMEA', 'NÃO INFORMADO', 'AMBOS', 'MACHO']
SEDENTARIO        = ['SIM', 'NÃO INFORMADO', 'NÃO']
